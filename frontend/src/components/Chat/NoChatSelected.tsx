...
const NoChatSelected = () => {
  ...
  const setChatRoomVisibilityOnMobile = useChatStore(
    (state) => state.setChatRoomVisibilityOnMobile
  );
  ...
  return (
    <div className="no__chat__selected">
      ...
      {rooms.length === 0 ? (
        ...
        <>
          <p>
            Sélectionnez une Chat Room et lancez-vous dans une conversation !
          </p>
          <button
            className="no__data"
            type="button"
            onClick={() => setChatRoomVisibilityOnMobile(false)}
          >
            Sélectionner
          </button>
        </>
